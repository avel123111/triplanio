...
// перебивает `app.css` в 18 объявлениях, и три из них живые — голый <h4> берёт
// Exo 16px вместо канона `.t-label`, голый <h2> вес 600 вместо 800, а
// `app.css` `a{color:var(--brand)}` мёртв целиком. Чинится это ОТДЕЛЬНЫМ
