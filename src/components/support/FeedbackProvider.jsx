...
function FeedbackDialog({ source, onClose }) {
  ...
  return (
    <Dialog
      ...
      icon="headset"
      /* На телефоне это ЭКРАН, а не окно: внутри поле и дропзона, а шторка по
         ...
         кареткой. Полный рост эту высоту убирает как величину: верх прибит к
         нулю, клавиатура сжимает только тело. Та же роль, что у шторки пикера. */
      full
      onClose={onClose}
      foot={(
        <>
