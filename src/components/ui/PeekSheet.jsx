 ...
 * ПОВЕРХ, раскладка не сжимается, и `position: fixed` остаётся привязан к ней.
 * Без этого слагаемого низ шита оказывался бы под клавиатурой, а при
 * панорамировании Safari — за верхним краем. Прежде директива была
 * `resizes-content`, и на Chrome смещение было нулём — то есть эта ветка молча
 * работала только на iOS; теперь она несущая на обеих платформах.
 */
