 ...
 * (TRIP-494). Таких поверхностей в приложении ДВЕ — шторка пикера и оболочка
 * панелей редактора, — и это одна и та же вещь: экран во весь вьюпорт, коробка
 * от раскладки, краска общая, бровь общая, клавиатура резервирует место внутри.
 *
