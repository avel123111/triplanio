 ...
 *
 * floor-exempt: dsshare +2 — схлопывание 4 копий vaul-обвязки в один шов убирает JSX-узлы обвязки (Portal/Overlay/Content ×4 → SheetSurface); апрув НЕ получен заранее, решение по метрике — на ревью самого PR
 */
