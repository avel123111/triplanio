    ...
    <div className="chat-composer">
      <div className="col col--g4 chat-composer__in">
        ...
        {/* Композер - это и есть `InputGroup`: рамка, фон и фокус-кольцо вокруг
            ...
            отступы, «плавающая» тень дока и вертикальное центрирование кнопок
            @/отправки (они компактнее поля, TRIP-337). Радиус тоже общий с
            полями: приподнятость дока несёт тень, а не форма угла. Оверлей
            меншенов не тронут. */}
