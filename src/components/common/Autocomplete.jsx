    ...
    return (
      <>
        {/* Триггер — ТО ЖЕ поле, а не его двойник: те же декорации (флаг
            ...
            скин. Меняется одно — ввод уезжает в шторку, поэтому поле только
            читается. `preventDefault` на mousedown гасит фокус: без него iOS
            успевает поднять клавиатуру ПОД открывающейся шторкой. Кнопка «×»
            гасит своё событие сама и шторку не открывает. */}
        <Input
          icon={icon}
          value={inputValue || ''}
          readOnly
