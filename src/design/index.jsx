...
// Тип оси `variant` переехал в `./Btn` вместе с самой кнопкой; баррель
// переобъявляет его, чтобы у внешних потребителей
// (`import('@/design/index').BtnVariant`) публичная поверхность не изменилась.
/** @typedef {import('./Btn').BtnVariant} BtnVariant */
export { Btn, BTN_VARIANTS } from './Btn';
