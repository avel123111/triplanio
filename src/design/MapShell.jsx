 ...
 *
 *   <MapShell
 *     map={(camera, slotPx) => <FlowMap camera={camera} slotPx={slotPx} … />}
 ...
 * Первую карта берёт всегда (по ней кадрирует следующий фит маршрута); вторая
 * нужна ТОЛЬКО тем, у кого размер предмета считается от холста (пустой глобус
 * планировщика), поэтому карты трипа второй аргумент не берут вовсе.
 *
 * @param {{
 *   map: any,
 *   panel?: any,
