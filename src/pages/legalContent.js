...
// серверные события (`captureServer`: покупка, второй участник, привязка
// Telegram) уходят независимо от баннера, на легитимном интересе, и в проекте
// им соответствуют живые персоны.
