...
//   1. КАДР ПОЕЗДКИ — что это и где: обложка + состояние во времени + ГОТОВНОСТЬ
//      слева, большая КАРТА справа, числа маршрута полосой по низу. Карта здесь
//      главная и видна сразу: до пересборки она была превью на 280 px и уезжала
//      под сгиб, стоило добавить на экран что-нибудь ещё.
