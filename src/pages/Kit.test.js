 ...
 * `index.jsx` (`<Avatar deleted/>` рисует `avatar--deleted`, строки в разметке нет).
...
/** ★ ХРАПОВИК ДОЛГА, а не запрет. Сегодня долг ПРИМИТИВА = 0. Экранные адаптивы
 *  `seg--filter`/`seg--view` из списка ушли вместе с самими сегментами: у главной
 *  больше нет ни вкладок «Активные/Прошедшие», ни переключателя грид/список.
...
const NOT_SHOWN = new Set(['tt--block']);
