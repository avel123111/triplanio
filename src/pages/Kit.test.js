...
/** ★ ХРАПОВИК ДОЛГА, а не запрет. Сегодня долг ПРИМИТИВА = 0. `seg--filter`
 *  упразднён вместе с Seg-табами главной (секции «Активные/Прошедшие» видны
 *  друг под другом), `seg--view` остался чистым экранным именем без CSS-правил
 *  (адаптив order/flex ушёл вместе с рядом фильтров) — долга больше нет.
 *  Форма та же, что у остальных обходов: список называет ровно то, что гасит. */
...
const NOT_SHOWN = new Set(['tt--block', 'page-main--wide']);
