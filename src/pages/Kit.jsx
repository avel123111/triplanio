    ...
    <div className="col col--g8" style={{ padding: 'var(--sp-8)', maxWidth: 1120, margin: '0 auto' }}>
      ...
      <Section title={TX.sections.components}>
        ...
        {/* Облик «добавить пересадку» (EventEditDialog): пунктир БЕЗ плитки и
            иконки, текст по центру. В приложении акцент транспорта приходит из
            `--hl` оболочки события через ховер-фолбэк `var(--a, var(--hl, …))`;
            здесь задаём `--hl` на обёртке, чтобы показать ховер-акцент. В покое
            серый, на ховере — цвет типа. */}
