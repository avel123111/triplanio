...
// floor-exempt: dsshare +15 — ЗАМЕР, А НЕ ОЦЕНКА. Доля 42.92% → 42.63%,
// числитель 1455 → 1425, знаменатель 3390 → 3343. Слагаемых четыре, и все —
...
//   (4) −1bp: ряд «выбранный город + изменить» диалог статистики собирал ЗАНОВО
//       (карточка ДС + флаг + имя, четыре листа) — теперь это один вызов общего
//       `cities/SelectedCity`. Тот же счёт: дубль снят, числитель просел. Он же
//       унёс ШЕСТЬ инлайнов — их в этом PR стало на 6 меньше базы (480 → 474).
