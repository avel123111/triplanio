export default {
  // Page titles
  'ai_plan.page_title': 'AI Планировщик Поездок',
  ...
  'ai_plan.prompt_placeholder_refine': 'Например, добавьте однодневную поездку в Тиволи, измените отели на центр города...',
  'ai_plan.shortcut_hint': 'Нажмите ⌘+Enter или Ctrl+Enter для отправки',
  ...
  'ai_plan.error_plan_desc': 'Не удалось создать поездку. Попробуйте снова.',
  ...
  'ai_plan.assistant_hint': 'опиши трип одним абзацем',
  'ai_plan.generate_draft': 'Сгенерировать черновик',
  'ai_plan.regenerate': 'Перегенерировать',
  'ai_plan.status_waiting': 'Жду промпт. Опиши трип одним абзацем — соберу черновик и обсудим детали в этом чате.',
  'ai_plan.status_generating': 'Подбираю города и переезды… собираю активности по дням.',
  'ai_plan.status_saving': 'Создаю реальный трип — города, переезды и активности материализуются.',
  ...
  'ai_plan.chip_balkans': 'Балканы на машине, 12 дней',
  'ai_plan.map_placeholder': 'Карта появится здесь',
  'ai_plan.draft_label': 'Черновик',
  'ai_plan.draft_placeholder_sub': 'Города, даты и активности — сгенерируем после промпта.',
  'ai_plan.empty_draft_cities': 'Черновик пуст — попроси ИИ что-нибудь добавить.',
  'ai_plan.save_disabled_hint': 'Сначала сгенерируй черновик',
  'ai_plan.unit_nights': 'ночей',
  'ai_plan.unit_cities': 'городов',
