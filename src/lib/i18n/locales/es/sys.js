export default {
  ...
  'sys.not_found_body': 'Puede que el enlace esté desactualizado o tenga un error. Vuelve a tus viajes: desde ahí es fácil encontrar lo que necesitas.',
  'sys.to_home': 'Al inicio',
};
