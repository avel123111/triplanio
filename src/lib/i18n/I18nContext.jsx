...
export function I18nProvider({ children }) {
  ...
  // переключателю. С TRIP-533 запись питает РАЗВИЛКУ (`index.html`): она уводит
  // с беспрефиксного адреса на языковой ровно тогда, когда язык заявлен, а
  // «заявлен» значит «лежит в хранилище». Беспрефиксный `/` не запоминается: он
  // английский по построению файла, а не по выбору, и записью стёр бы настоящий
  // выбор посетителя — после чего развилка перестала бы его узнавать.
