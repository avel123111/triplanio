 ...
 * утверждение о языке, как клик по переключателю).
 *
 * ★ С TRIP-533 ЭТА ЗАПИСЬ СТАЛА НЕСУЩЕЙ, А НЕ ВСПОМОГАТЕЛЬНОЙ. Раньше она
 * существовала ради страниц, у которых языкового адреса не было (вход); теперь
 * он есть у всей зоны, зато ИМЕННО ЭТИМ ЗНАЧЕНИЕМ питается развилка в
 * `index.html`: беспрефиксный адрес уводит на языковой ровно тогда, когда язык
 * ЗАЯВЛЕН, а «заявлен» = «лежит здесь». Снимешь запись — развилка перестанет
 * срабатывать, и вернувшийся снова получит английскую страницу.
 *
