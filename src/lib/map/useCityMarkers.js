 ...
 * и планировщика (тогда `FlowMap`; с TRIP-520 планировщик рисует тот же `MapView`). До этого оба гоняли построчно совпадающие эффекты:
 ...
 * фокус/reveal/hotel, у планировщика — пустой глобус), и общий шов их бы только
