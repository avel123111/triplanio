...
// участников по рангу, строка-владелец в списке): они остаются и после Ф2.1.
// Гейты (readOnly/canManage/canEdit/affordance) обязаны уйти в лестницу. Когда
// счётчик гейтов дойдёт до нуля, репортёр флипается в блокирующий с явным
// allowlist на эти display-строки (правка ревьюера п.1).
