...
- **Migrations — still MANUAL, no CI** (Ф3 / TRIP-68, blocked on migration-history reconcile). Apply via MCP `apply_migration` / CLI to **BOTH** projects; nothing deploys SQL on push.
