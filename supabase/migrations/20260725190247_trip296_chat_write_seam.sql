...
--
-- caps-guard: allow-uncapped — файл не добавляет НИ ОДНОЙ колонки (все они в
-- предыдущей миграции). Гард 2g построчный и принимает `p_text text` в сигнатуре
-- функции за объявление колонки. Сами значения ограничены в теле: текст
-- сообщения — char_length(v_text) > 10000 → ошибка, ответ — left(p_reply, 10000),
-- код ошибки — left(p_error, 300).
