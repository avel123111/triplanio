 ...
 * Клиент шлёт ОБА, отдельными запросами, и склеивает выдачи у себя: за одно тело
 * Stay22 берёт ровно одно гео, так что «и центр, и площадь» — это две ходки, а
 * не один хитрый набор параметров.
 *
