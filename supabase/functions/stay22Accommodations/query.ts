 ...
 *
 * Сейчас прямоугольник только ПРОБРАСЫВАЕТСЯ: клиент его ещё не шлёт, поэтому на
 * сегодняшнем теле запроса строка получается ровно та же, что и до этой правки —
 * ровно это пинует тест «без коробки строка не изменилась».
 */
