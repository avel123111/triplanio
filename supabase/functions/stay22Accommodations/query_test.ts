...
// ГЛАВНЫЙ ТЕСТ ЭТОЙ ПРАВКИ. Прямоугольник добавлен как проброс, и пока клиент его
// не шлёт, строка запроса обязана остаться той же ДО ЗНАКА — включая порядок
// параметров. Строка ниже снята с рабочего прода (версия функции 61) и вписана
// СЫРЬЁМ намеренно: сравнение с пересобранным ожиданием проверяло бы код кодом.
