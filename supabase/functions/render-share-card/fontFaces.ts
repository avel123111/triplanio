...
// Пятый сабсет — один глиф U+2192 (стрелка маршрута). Google её ни в один
// стандартный сабсет не кладёт, см. src/design/fonts.css.
const GEO_ARROW = 'U+2192';
const GEO_LATIN_EXT =
...
const FONT_FACES: Face[] = [
  ...
  { family: 'Geologica', weight: '400 800', format: 'woff2', range: GEO_ARROW, idx: 4 },
];
