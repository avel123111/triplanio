...
provider_env (test/live) в provider_price: Pavel рассматривал ручную правку per-env вместо колонки; решение оставлено за ним (рекомендация — декларативный сид-в-миграции ради воспроизводимости, «лишние» test-строки в prod никогда не читаются в live-режиме). Связь: [[triplanio-payments-deep-audit]] [[triplanio-payments-phase-status]] [[triplanio-pro-model]] [[triplanio-stripe-integration]] [[triplanio-cancel-downgrade-no-tripsubrow-bug]]
