...
- **Native Supabase↔GitHub Git-интеграцию** надо выключить в дашборде (дашборд-тумблер, API нет) — деплой миграций по решению Pavel остаётся РУЧНЫМ (агент готовит команды). Новые миграции: один таймстамп-файл → катить руками на оба проекта.
