...
- **Free** (1 активный трип): все базовые линзы (таймлайн, карта, документы, календарь, подбор отелей/активностей); полная коллаборация (безлимит приглашённых, real-time, шеринг-ссылка) - НЕ гейтить, это виральное топливо (VOC тема K: рынок ненавидит платный шеринг); ручные брони; «Моя статистика»; **базовые in-app уведомления, включая базовый алерт о бесплатной отмене** (доставка in-app).
